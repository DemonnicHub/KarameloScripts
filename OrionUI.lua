...
if not Success then
	warn("\nDemonnic Hub X Karamelo - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if DemonnicLib.Flags[a] then
			...
			warn("Demonnic Hub X Karamelo Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function DemonnicLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Demonnic Hub X Karamelo"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Demonnic Hub X Karamelo"
